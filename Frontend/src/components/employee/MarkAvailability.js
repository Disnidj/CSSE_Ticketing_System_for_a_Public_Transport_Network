...
useEffect(function effectFunction() {
  ...
  .then(res=>{
    ...
    <center>
        ...
        <br/><br/>
        <h1 style={{ textAlign:'center',fontSize:"60px", height:'80px', backgroundColor:"#87ceeb", marginTop:'-100px'}}>Mark Availability</h1>
        <br/><br/>
                    ...
                    <br/><br/>
                     ...
                     <tr>
                        ...
                        <div className="form-group" style={{marginBottom:'15px',color:'white'}}>
                              ...
                              name="Availability"
                              className="form-control"
                              placeholder="Select your Availability state"              
                              value={Availability} 
